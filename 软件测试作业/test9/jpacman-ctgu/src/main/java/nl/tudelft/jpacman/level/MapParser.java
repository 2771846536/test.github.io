...
public class MapParser {
    ...
    /**
     * Creates a new map parser.创建新的地图解析器
     *
     * @param levelFactory
    ...
    //makGrid 根据地图的字符数组，创建二维方块表示地图布局
    //grid二维方块数组，存储地图的方块布局
     ...
     */
    public Level parseMap(InputStream source) throws IOException {   //从输入流中读数据，解析为关卡对象。
    ...
    public Level parseMap(String mapName) throws IOException {  //根据资源名称读取数据，并将其解析为游戏关卡对象，
